...
public class CourseConfig : IEntityTypeConfiguration<Domain.CourseAgg.Models.Course>
{
    public void Configure(EntityTypeBuilder<Domain.CourseAgg.Models.Course> builder)
    {
