...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreModule.Domain.CategoryAgg.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CoreModule.Domain.CourseAgg.Models.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreModule.Domain.TeacherAgg.Models.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreModule.Domain.CategoryAgg.Models.Category", b =>
                {
                    b.HasOne("CoreModule.Domain.CategoryAgg.Models.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CoreModule.Domain.CourseAgg.Models.Course", b =>
                {
                    ...
                    b.OwnsMany("CoreModule.Domain.CourseAgg.Models.Section", "Sections", b1 =>
                        {
                            b1.Property<Guid>("CourseId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("CoreModule.Domain.CourseAgg.Models.Episode", "Episodes", b2 =>
                                {
            ...
            modelBuilder.Entity("CoreModule.Domain.TeacherAgg.Models.Teacher", b =>
                {
                    b.HasOne("CoreModule.Infrastructure.Persistent.Users.User", null)
                        .WithOne()
                        .HasForeignKey("CoreModule.Domain.TeacherAgg.Models.Teacher", "UserId")
