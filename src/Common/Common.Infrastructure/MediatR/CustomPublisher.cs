...
public class CustomPublisher : ICustomPublisher
{
    public CustomPublisher(IServiceProvider serviceProvider)
    {
        ...
        PublishStrategies[PublishStrategy.Async] = new CustomMediator(serviceProvider1, AsyncContinueOnException);
        PublishStrategies[PublishStrategy.ParallelNoWait] = new CustomMediator(serviceProvider1, ParallelNoWait);
        PublishStrategies[PublishStrategy.ParallelWhenAll] = new CustomMediator(serviceProvider1, ParallelWhenAll);
        PublishStrategies[PublishStrategy.ParallelWhenAny] = new CustomMediator(serviceProvider1, ParallelWhenAny);
        PublishStrategies[PublishStrategy.SyncContinueOnException] = new CustomMediator(serviceProvider1, SyncContinueOnException);
        PublishStrategies[PublishStrategy.SyncStopOnException] = new CustomMediator(serviceProvider1, SyncStopOnException);
    }
